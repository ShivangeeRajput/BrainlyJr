...
import com.techymonk.happyzone.interfaces.AdsCallback;
import com.techymonk.happyzone.interfaces.CallbackListener;
import com.techymonk.happyzone.utils.CommonConstantAd;
...
public class SplashActivity extends AppCompatActivity implements CallbackListener, AdsCallback {
    ...
    public void startNextActivity(Integer time) {
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent = new Intent(SplashActivity.this, HomeNew.class);
